...
var JuiceSLider = new Class({
	...
	initialize: function(container,options)
	{
		...
		this.itemWidth = this.container.getSize().x - elems.length*this.options.closedWidth;
		...
		// respect padding
		var pad = this.container.getElement('.juiceSliderItem div').getStyles('padding-left','padding-right');
		var innerWidth = this.itemWidth - pad['padding-left'].toInt() - pad['padding-right'].toInt();
		elems.each(function(el,index){
			el.setStyle('width',innerWidth);
		}.bind(this));
